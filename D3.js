...
console.log("NomiPersonaggi", charactersNames);
...
console.log("colori personaggi", eyeColor);
/* ESERCIZIO 6
...
console.log("personaggi cambiati genere", starWarsCharacters);
/* --EXTRA-- ESERCIZIO 9
  Utilizzando gli elementi presenti nell'array "femaleCharacters" rimuovi dall'array "charactersNames" le stringhe corrispondenti a personaggi con lo stesso nome.
  Una volta fatto crea un console.log per controllare la proprietà length di "charactersNames" prima e dopo l'operazione.
*/
console.log("lunghezza nomi personaggi doppiati:" + charactersNames.length);
...
console.log("lunghezza nomi personaggi non doppiati:" + charactersNames.length);
console.log("nomi personaggi non doppiati (senza female):", charactersNames);

/* --EXTRA-- ESERCIZIO 10
  Crea una funzionalità che selezioni un elemento casuale dall'array "starWarsCharacters" e ne stampi in console le proprietà in modo discorsivo (a tuo piacimento).
*/

let indiceCasuale = Math.floor(Math.random() * starWarsCharacters.length);
console.log(indiceCasuale);
let oggettoCasuale = starWarsCharacters[indiceCasuale];
console.log(oggettoCasuale);
console.log(
  "questo personaggio si chiama " +
    oggettoCasuale.name +
    ", è alto " +
    oggettoCasuale.height +
    ", pesa " +
    oggettoCasuale.mass +
    " , ha i capelli di colore " +
    oggettoCasuale.hair_color +
    " , ha la pelle di colore " +
    oggettoCasuale.skin_color +
    " , ha il colore degli " +
    oggettoCasuale.eye_color +
    ", è nato nel " +
    oggettoCasuale.birth_year +
    " e il suo genere è " +
    oggettoCasuale.gender
);
